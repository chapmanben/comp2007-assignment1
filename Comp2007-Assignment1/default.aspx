...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="panelSummary" runat="server">
        <!-- Summary Labels -->
        <asp:Label ID="lblGameSummary" runat="server" Text="Game Summary"></asp:Label> <br />
        <asp:Label ID="lblGamesWon" runat="server" Text=""></asp:Label> <br />
        <asp:Label ID="lblGamesLost" runat="server" Text=""></asp:Label> <br />
        <asp:Label ID="lblWinnings" runat="server" Text=""></asp:Label> <br />
        <asp:Label ID="lblTotalPointsScored" runat="server" Text=""></asp:Label> <br />
        <asp:Label ID="lblTotalPointsAllowed" runat="server" Text=""></asp:Label> <br />
        <asp:Label ID="lblPointDifferential" runat="server" Text=""></asp:Label> <br />
        <asp:Label ID="lblTotalSpectators" runat="server" Text=""></asp:Label> <br />
        <asp:Label ID="lblAverageSpectators" runat="server" Text=""></asp:Label> <br />
    </asp:Panel>
